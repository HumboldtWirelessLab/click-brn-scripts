...
ERR_PACKETS=`cat $RESULTDIR/measurement.log | grep "<rxflow src=" | sed 's#"# #g' | sed "s#=# #g" | awk '{print $13}'`

echo -n "Send $SEND_PACKETS packet and $RECV_PACKETS packets are received."
