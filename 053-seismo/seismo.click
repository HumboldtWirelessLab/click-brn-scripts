...
gps::GPS();
seismo::Seismo(GPS gps, PRINT false, RECORD true, SHORTTAGS true, DATAFILEPREFIX "CONFIGDIR/data/data.txt.", DATAFILEINTERVAL 100, DEBUG 2);
