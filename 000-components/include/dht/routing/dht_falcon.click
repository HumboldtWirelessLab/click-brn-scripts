elementclass DHT_FALCON { ETHERADDRESS $etheraddress, LINKSTAT $lt, STARTTIME $starttime, UPDATEINT $updateint, DEBUG $debug |
  ...
  dhtrouting :: DHTRoutingFalcon(FRT dhtroutingtable, RESPONSIBLE 1);
...
||
 ...
 ETHERADDRESS $etheraddress, LINKSTAT $lt, STARTTIME $starttime, UPDATEINT $updateint, DEBUG $debug, REGISTERHANDLER $regh |
  ...
  dhtlprh :: FalconLinkProbeHandler(FRT dhtroutingtable, LINKSTAT $lt, REGISTERHANDLER regh);
  dhtrouting :: DHTRoutingFalcon(FRT dhtroutingtable, RESPONSIBLE 1);
