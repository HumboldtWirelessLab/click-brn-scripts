  ...
  for cm_i = 1:size(cmodel,1)
    for tar_i = 1:size(all_targets,1)
      ...
      if ( plot_all == 1 )
        ...
        fname=strcat('bo_target_', target_string(all_targets(tar_i)+1) , '_channelmodel_', cm_string(cmodel(cm_i)+1),'.png');
        saveas(h2, fname{1} ,'png');      
        fname=strcat('bo_target_', target_string(all_targets(tar_i)+1) , '_channelmodel_', cm_string(cmodel(cm_i)+1),'.eps');
        ...
        fname=strcat('jfi_target_', target_string(all_targets(tar_i)+1) , '_channelmodel_', cm_string(cmodel(cm_i)+1),'.png');
        saveas(h3, fname{1} ,'png');      
        fname=strcat('jfi_target_', target_string(all_targets(tar_i)+1) , '_channelmodel_', cm_string(cmodel(cm_i)+1),'.eps');
