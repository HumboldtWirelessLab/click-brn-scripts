...
echo "NUM,NO_NODES,PACKETSIZE,BACKOFF_MAX,BACKOFF,SEED,RATE,TIME,NODE,ID,PHY_HWBUSY,PHY_HWRX,PHY_HWTX,RXPKT,CRCPKT,PHYPKT,ADDR,RSSI,STDRSSI,MINRSSI,MAXRSSI,PKTCNT" > inrange.mat.tmp
