...
while [ true ]; do
  ...
  if [ "x$GPSPOS" != "x0.0 0.0 0.0" ]; then
    ...
    echo "localhost"
    echo "" | $DIR/../../../../helper/host/bin/clickctrl.sh write localhost 7777 gps gps_coord "$GPSPOS"
    echo "" | $DIR/../../../../helper/host/bin/clickctrl.sh write localhost 7777 gps speed "$SPEED"
#    echo "localhost"
