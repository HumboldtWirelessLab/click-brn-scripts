...
brn_clf[0]
-> BRN2Decap()
-> topo_detect::TopologyDetection(TOPOLOGY_INFO topo_info, NODE_IDENTITY id, LINK_TABLE lt, DEBUG 0, ORIGIN_FORWARD_DELAY true, POBABILITY_OF_PREIODICALLY_DETECTION 0.5, IS_DETECTION_PERIODICALLY false, RANDOM_START_DELAY_MS 20000, DETECTION_INTERVAL_MS 15000, USE_LINK_STAT true, MAX_HOPS 12)
-> SetTimestamp()
