...
# Limit practically APs to 01 and 02
sed  -n -i "/00-00-00-00-00-0[1,2]/p" ${RESULTDIR}/articulation_points.csv 

# Limit theo AP to 01 and 02
echo "\"articulation_point\"" >> ${RESULTDIR}/theoretical_articulation_points.csv
echo "00-00-00-00-00-01" >> ${RESULTDIR}/theoretical_articulation_points.csv
echo "00-00-00-00-00-02" >> ${RESULTDIR}/theoretical_articulation_points.csv
