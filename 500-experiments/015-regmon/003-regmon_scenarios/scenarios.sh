...
cat sender.click.tmpl | sed "s#PARAM_TXINTERVAL#$TXINTERVAL#g" | sed "s#PARAM_TXPOWER#$TXPOWER#g" | sed "s#PARAM_TXRATE#$TXRATE#g" > sender.click
cat sender_nocca.click.tmpl | sed "s#PARAM_DISPI#$DISTXINTERVAL#g" | sed "s#PARAM_DISPS#$DISPKTSIZE#g" | sed "s#PARAM_DISTXPOWER#$DISTXPOWER#g" > sender_nocca.click

cat monitor.tmpl | sed "s#PARAM_TXPOWER#$TXPOWER#g" > monitor
cat monitor_nocca.tmpl | sed "s#PARAM_DISTXPOWER#$DISTXPOWER#g" > monitor_nocca
