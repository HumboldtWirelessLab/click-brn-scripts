...
show_configs=show_configs(show_configs(:,CONFIG_ALGORITHMID) == 2,:);

show_configs=show_configs(show_configs(:,CONFIG_FLOODING_NET_RETRIES) == 2,:);
...
show_configs=show_configs(show_configs(:,CONFIG_NBMETRIC) == 400,:);
...
%use 25ms delay
show_configs=show_configs(show_configs(:,CONFIG_MAXDELAY) == 25,:);
