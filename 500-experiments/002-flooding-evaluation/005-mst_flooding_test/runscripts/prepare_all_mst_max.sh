...
sed 's/circles1_1/1_mst.txt/g' < controlfiles/flooding_max_mst.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 1_mst_max;
echo 'Finished 1';
...
sed 's/circles1_1/2_mst.txt/g' < controlfiles/flooding_max_mst.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 2_mst_max;
echo 'Finished 2';
...
sed 's/circles1_1/3_mst.txt/g' < controlfiles/flooding_max_mst.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 3_mst_max;
echo 'Finished 3';
...
sed 's/circles1_1/62_4_clusters_mst.txt/g' < controlfiles/flooding_max_mst.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 62_4_clusters_mst_max;
...
sed 's/circles1_1/97_5_clusters_mst.txt/g' < controlfiles/flooding_max_mst.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 97_5_clusters_mst_max;
...
PREPARE_ONLY=1 run_sim.sh ns flooding.des multibox1_mst_max;
...
PREPARE_ONLY=1 run_sim.sh ns flooding.des multibox2_mst_max;
...
PREPARE_ONLY=1 run_sim.sh ns flooding.des multibox3_mst_max;
