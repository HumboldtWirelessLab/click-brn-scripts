...
PREPARE_ONLY=1 run_sim.sh ns flooding.des 1_1_all_source_bidirectional;
echo -e "1_1 finished\n";
sed 's/circles1_1/circles1_2/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 1_2_all_source_bidirectional;
echo -e "1_2 finished\n";
sed 's/circles1_1/circles1_3/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 1_3_all_source_bidirectional;
echo -e "1_3 finished\n";
sed 's/circles1_1/circles1_4/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 1_4_all_source_bidirectional;
echo -e "1_4 finished\n";
...
PREPARE_ONLY=1 run_sim.sh ns flooding.des 2_1_all_source_bidirectional;
echo -e "2_1 finished\n";
sed 's/circles1_1/circles2_2/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 2_2_all_source_bidirectional;
echo -e "2_2 finished\n";
sed 's/circles1_1/circles2_3/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 2_3_all_source_bidirectional;
echo -e "2_3 finished\n";
sed 's/circles1_1/circles2_4/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 2_4_all_source_bidirectional;
echo -e "2_4 finished\n";
cp controlfiles/flooding_smpl.click flooding.click;
...
PREPARE_ONLY=1 run_sim.sh ns flooding.des 3_1_all_source_bidirectional;
echo -e "3_1 finished\n";
sed 's/circles1_1/circles3_2/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 3_2_all_source_bidirectional;
echo -e "3_2 finished\n";
sed 's/circles1_1/circles3_3/g' < controlfiles/flooding_bd.click > flooding.click;
PREPARE_ONLY=1 run_sim.sh ns flooding.des 3_3_all_source_bidirectional;
echo -e "3_3 finished\n";
cp controlfiles/flooding_smpl.click flooding.click;
