...
2.5	sk2		ath0	write	sf	add_flow	sk2:eth sk1:eth 50 1500 2 90 true 1 0
2.6	sk2		ath0	write	sf	add_flow	sk2:eth sk3:eth 50 1500 2 90 true 1 0
2.7	sk2		ath0	write	sf	add_flow	sk2:eth sk4:eth 50 1500 2 90 true 1 0
2.8	sk2		ath0	write	sf	add_flow	sk2:eth sk5:eth 50 1500 2 90 true 1 0
2.9	sk2		ath0	write	sf	add_flow	sk2:eth sk6:eth 50 1500 2 90 true 1 0
3.0	sk3		ath0	write	sf	add_flow	sk3:eth sk1:eth 50 1500 2 90 true 1 0
3.1	sk3		ath0	write	sf	add_flow	sk3:eth sk2:eth 50 1500 2 90 true 1 0
3.2	sk3		ath0	write	sf	add_flow	sk3:eth sk4:eth 50 1500 2 90 true 1 0
3.3	sk3		ath0	write	sf	add_flow	sk3:eth sk5:eth 50 1500 2 90 true 1 0
3.4	sk3		ath0	write	sf	add_flow	sk3:eth sk6:eth 50 1500 2 90 true 1 0
3.5	sk4		ath0	write	sf	add_flow	sk4:eth sk1:eth 50 1500 2 90 true 1 0
3.6	sk4		ath0	write	sf	add_flow	sk4:eth sk2:eth 50 1500 2 90 true 1 0
3.7	sk4		ath0	write	sf	add_flow	sk4:eth sk3:eth 50 1500 2 90 true 1 0
3.8	sk4		ath0	write	sf	add_flow	sk4:eth sk5:eth 50 1500 2 90 true 1 0
3.9	sk4		ath0	write	sf	add_flow	sk4:eth sk6:eth 50 1500 2 90 true 1 0
4.0	sk5		ath0	write	sf	add_flow	sk5:eth sk1:eth 50 1500 2 90 true 1 0
4.1	sk5		ath0	write	sf	add_flow	sk5:eth sk2:eth 50 1500 2 90 true 1 0
4.2	sk5		ath0	write	sf	add_flow	sk5:eth sk3:eth 50 1500 2 90 true 1 0
4.3	sk5		ath0	write	sf	add_flow	sk5:eth sk4:eth 50 1500 2 90 true 1 0
4.4	sk5		ath0	write	sf	add_flow	sk5:eth sk6:eth 50 1500 2 90 true 1 0
4.5	sk6		ath0	write	sf	add_flow	sk6:eth sk1:eth 50 1500 2 90 true 1 0
4.6	sk6		ath0	write	sf	add_flow	sk6:eth sk2:eth 50 1500 2 90 true 1 0
4.7	sk6		ath0	write	sf	add_flow	sk6:eth sk3:eth 50 1500 2 90 true 1 0
4.8	sk6		ath0	write	sf	add_flow	sk6:eth sk4:eth 50 1500 2 90 true 1 0
4.9	sk6		ath0	write	sf	add_flow	sk6:eth sk5:eth 50 1500 2 90 true 1 0
6.0	sk1		ath0	read	sf	stats
6.0	sk2		ath0	read	sf	stats
6.0	sk3		ath0	read	sf	stats
6.0	sk4		ath0	read	sf	stats
6.0	sk5		ath0	read	sf	stats
6.0	sk6		ath0	read	sf	stats
6.1	sk1		ath0	read	device_wifi/wifidevice/hnd	stats
6.1	sk2		ath0	read	device_wifi/wifidevice/hnd	stats
6.1	sk3		ath0	read	device_wifi/wifidevice/hnd	stats
6.1	sk4		ath0	read	device_wifi/wifidevice/hnd	stats
6.1	sk5		ath0	read	device_wifi/wifidevice/hnd	stats
6.1	sk6		ath0	read	device_wifi/wifidevice/hnd	stats
