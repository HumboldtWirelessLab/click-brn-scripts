...
for {set i 1} {$i < $nodecount } {incr i} {
    ...
    # script.
    #
[$node_($i) entry] loadclick "bcr_simpleflow_out.click"
}

[$node_(0) entry] loadclick "bcr_simpleflow_src_out.click"
...
#$ns_ at 10.5000000000 "[$node_(0) entry] readhandler bcr/sfl stat"
