...
$ns_ at  0.0 "puts \"\[\[$node_(1) entry\] writehandler dht/dhtrouting node_id \"10000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(2) entry\] writehandler dht/dhtrouting node_id \"20000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(3) entry\] writehandler dht/dhtrouting node_id \"30000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(4) entry\] writehandler dht/dhtrouting node_id \"40000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(5) entry\] writehandler dht/dhtrouting node_id \"50000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(6) entry\] writehandler dht/dhtrouting node_id \"60000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(7) entry\] writehandler dht/dhtrouting node_id \"70000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(8) entry\] writehandler dht/dhtrouting node_id \"80000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(9) entry\] writehandler dht/dhtrouting node_id \"90000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(10) entry\] writehandler dht/dhtrouting node_id \"a0000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(11) entry\] writehandler dht/dhtrouting node_id \"b0000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(12) entry\] writehandler dht/dhtrouting node_id \"c0000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(13) entry\] writehandler dht/dhtrouting node_id \"d0000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(14) entry\] writehandler dht/dhtrouting node_id \"e0000000000000000000000000000000 128\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(15) entry\] writehandler dht/dhtrouting node_id \"f0000000000000000000000000000000 128\" \]\""
#
# Stop the simulation
#
