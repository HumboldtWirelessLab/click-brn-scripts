...
#$ns_ at  0.0 "puts \"\[\[$node_(0) entry\] writehandler dht/dhtrouting node_id \"00000000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(1) entry\] writehandler dht/dhtrouting node_id \"071c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(2) entry\] writehandler dht/dhtrouting node_id \"0e380000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(3) entry\] writehandler dht/dhtrouting node_id \"15540000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(4) entry\] writehandler dht/dhtrouting node_id \"1c700000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(5) entry\] writehandler dht/dhtrouting node_id \"238c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(6) entry\] writehandler dht/dhtrouting node_id \"2aa80000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(7) entry\] writehandler dht/dhtrouting node_id \"31c40000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(8) entry\] writehandler dht/dhtrouting node_id \"38e00000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(9) entry\] writehandler dht/dhtrouting node_id \"40000000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(10) entry\] writehandler dht/dhtrouting node_id \"471c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(11) entry\] writehandler dht/dhtrouting node_id \"4e380000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(12) entry\] writehandler dht/dhtrouting node_id \"55540000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(13) entry\] writehandler dht/dhtrouting node_id \"5c700000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(14) entry\] writehandler dht/dhtrouting node_id \"638c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(15) entry\] writehandler dht/dhtrouting node_id \"6aa80000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(16) entry\] writehandler dht/dhtrouting node_id \"71c40000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(17) entry\] writehandler dht/dhtrouting node_id \"78e00000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(18) entry\] writehandler dht/dhtrouting node_id \"80000000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(19) entry\] writehandler dht/dhtrouting node_id \"871c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(20) entry\] writehandler dht/dhtrouting node_id \"8e380000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(21) entry\] writehandler dht/dhtrouting node_id \"95540000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(22) entry\] writehandler dht/dhtrouting node_id \"9c700000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(23) entry\] writehandler dht/dhtrouting node_id \"a38c0000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(24) entry\] writehandler dht/dhtrouting node_id \"aaa80000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(25) entry\] writehandler dht/dhtrouting node_id \"b1c40000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(26) entry\] writehandler dht/dhtrouting node_id \"b8e00000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(27) entry\] writehandler dht/dhtrouting node_id \"c0000000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(28) entry\] writehandler dht/dhtrouting node_id \"c5d10000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(29) entry\] writehandler dht/dhtrouting node_id \"cba20000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(30) entry\] writehandler dht/dhtrouting node_id \"d1730000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(31) entry\] writehandler dht/dhtrouting node_id \"d7440000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(32) entry\] writehandler dht/dhtrouting node_id \"dd150000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(33) entry\] writehandler dht/dhtrouting node_id \"e2e60000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(34) entry\] writehandler dht/dhtrouting node_id \"e8b70000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(35) entry\] writehandler dht/dhtrouting node_id \"ee880000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(36) entry\] writehandler dht/dhtrouting node_id \"f4590000000000000000000000000000 128\" \]\""
#$ns_ at  0.0 "puts \"\[\[$node_(37) entry\] writehandler dht/dhtrouting node_id \"fa2a0000000000000000000000000000 128\" \]\""
#
# Stop the simulation
#
