...
arpc::BRN2ARPClient(CLIENTIP 192.168.0.5, CLIENTETHERADDRESS deviceaddress, STARTIP 192.168.0.138,
...
//  -> Print("rx")
  ...
  -> dhcpr::BRN2DHCPClient(FIRSTETHERADDRESS deviceaddress, FIRSTIP 0.0.0.0, RANGE 1, STARTTIME 10000, DIFF 500, DEBUG 3)
...
-> Strip(28) // strip ip and udp
-> Discard;
//-> BRN2DNSClient("192.168.0.6.bloblo.org", 15000,1000,true,0)
Idle
