...
for {set i 0} {$i < $nodecount } {incr i} {
    ...
    # script.
    #
[$node_($i) entry] loadclick "geor_simpleflow_out.click"
}
...
for {set i 0} {$i < $nodecount} {incr i} {
    $node_($i) set X_ [expr $i % $sidelen * 50 ]
    $node_($i) set Y_ [expr $i / $sidelen * 50 ]
    $node_($i) set Z_ 0
...
$ns_ at  0.0 "puts \"\[\[$node_(0) entry\] writehandler geor/gps position \"0 0\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(1) entry\] writehandler geor/gps position \"100 0\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(2) entry\] writehandler geor/gps position \"200 0\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(3) entry\] writehandler geor/gps position \"300 0\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(1) entry\] writehandler geor/gfwd debug \"4\" \]\""
$ns_ at  0.0 "puts \"\[\[$node_(0) entry\] writehandler geor/grt  add \"00:0F:00:00:03:00 300 0 0\" \]\""
$ns_ at  5.0 "puts \"\[\[$node_(0) entry\] writehandler sf  active \"1\" \]\""
$ns_ at  10.0 "puts \"\[\[$node_(0) entry\] readhandler sf txflows \]\""
$ns_ at  10.0 "puts \"\[\[$node_(1) entry\] readhandler sf rxflows \]\""
$ns_ at  10.0 "puts \"\[\[$node_(2) entry\] readhandler sf rxflows \]\""
$ns_ at  10.0 "puts \"\[\[$node_(3) entry\] readhandler sf rxflows \]\""
