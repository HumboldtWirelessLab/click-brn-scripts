...
arpc::BRN2ARPClient(CLIENTIP 192.168.0.6, CLIENTETHERADDRESS deviceaddress, STARTIP 192.168.0.9,
...
#endif
  -> Strip(28) // strip ip and udp
  -> dnsc::BRN2DNSClient("192.168.0.9.bloblo.org", 65000, 1000, true, DEBUG 2)
